...
export function TopSection() {
    return (
        <TopSectionContainer>
            <LeftContainer>
                <Slogan>Alquilate los mejores autos de Mendoza</Slogan>
                <Description>Acercate a una de nuestras sucursales o pedilo de forma remota
